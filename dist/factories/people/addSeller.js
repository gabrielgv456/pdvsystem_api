...
exports.default = AddSeller;
const index_1 = __importDefault(require("../../services/prisma/index"));
function AddSeller(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { dataAddSeller } = request.body;
            if (!dataAddSeller) {
                throw new Error('Não localizado a propriedade "dataAddSeller" ');
            }
            const addSeller = yield index_1.default.sellers.create({
                data: {

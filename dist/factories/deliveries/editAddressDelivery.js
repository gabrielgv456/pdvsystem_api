...
exports.default = editAddressDeliveries;
...
function editAddressDeliveries(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0, validateFields_1.default)(requiredFields, dataChangeAddressDelivery);
            yield index_1.default.$transaction((prismaTx) => __awaiter(this, void 0, void 0, function* () {
                yield prismaTx.address.update({
                    where: {
                        id_storeId: {

...
export default async function chartsArea(request:Request, response : Response) {
    ...
    try {
        ...
        const qtdDays = createSequence(Number(lastPeriod)) // change to add more days
        ...
        const SellsChartArea: SellsChartAreaType[] = []

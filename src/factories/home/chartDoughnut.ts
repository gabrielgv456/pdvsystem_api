...
type GenderClientsType = { gender: string | null }

export default async function chartDoughnut(request: Request, response: Response) {
    ...
    try {
        ...
        const GenderClients: GenderClientsType[] = []

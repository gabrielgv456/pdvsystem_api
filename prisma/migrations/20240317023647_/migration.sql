/*
  ...
  - A unique constraint covering the columns `[id,storeId]` on the table `Sells` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Sells_id_storeId_key" ON "Sells"("id", "storeId");

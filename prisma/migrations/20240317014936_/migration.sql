/*
  ...
  - A unique constraint covering the columns `[productId]` on the table `TaxIpi` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TaxIpi_productId_key" ON "TaxIpi"("productId");

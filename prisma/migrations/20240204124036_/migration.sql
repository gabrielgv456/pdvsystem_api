/*
  ...
  - You are about to drop the column `taxCstAliquot` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "taxCstAliquot",
ADD COLUMN     "taxCstPisAliquot" DOUBLE PRECISION,

/*
  ...
  - A unique constraint covering the columns `[id,storeId]` on the table `Sellers` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Sellers_id_storeId_key" ON "Sellers"("id", "storeId");

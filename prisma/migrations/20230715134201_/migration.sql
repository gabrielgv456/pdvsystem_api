/*
  ...
  - You are about to drop the column `unitMeasuremnt` on the `Products` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Products" DROP COLUMN "unitMeasuremnt",
ADD COLUMN     "unitMeasurement" TEXT,

/*
  ...
  - A unique constraint covering the columns `[id,storeId]` on the table `Address` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Address_id_storeId_key" ON "Address"("id", "storeId");

/*
  ...
  - A unique constraint covering the columns `[id,storeId]` on the table `Deliveries` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Deliveries_id_storeId_key" ON "Deliveries"("id", "storeId");

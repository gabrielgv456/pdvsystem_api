/*
  ...
  - A unique constraint covering the columns `[taxIcmsId]` on the table `TaxIcmsNfe` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TaxIcmsNfe_taxIcmsId_key" ON "TaxIcmsNfe"("taxIcmsId");

/*
  ...
  - Added the required column `totalQuantity` to the `TransactionsProducts` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "TransactionsProducts" ADD COLUMN     "totalQuantity" INTEGER NOT NULL,

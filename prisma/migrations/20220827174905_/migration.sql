...
-- AlterTable
ALTER TABLE "Sells" ADD COLUMN     "clientId" INTEGER DEFAULT 3,
...
-- AddForeignKey
ALTER TABLE "Sells" ADD CONSTRAINT "Sells_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Clients"("id") ON DELETE SET NULL ON UPDATE CASCADE;

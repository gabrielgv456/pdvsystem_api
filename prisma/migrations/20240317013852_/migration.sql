/*
  ...
  - A unique constraint covering the columns `[productId]` on the table `TaxIcms` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TaxIcms_productId_key" ON "TaxIcms"("productId");

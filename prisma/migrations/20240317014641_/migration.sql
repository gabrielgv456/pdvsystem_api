/*
  ...
  - A unique constraint covering the columns `[taxIcmsId]` on the table `TaxIcmsST` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TaxIcmsST_taxIcmsId_key" ON "TaxIcmsST"("taxIcmsId");

/*
  ...
  - Added the required column `description` to the `TaxGroup` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "TaxGroup" ADD COLUMN     "description" TEXT NOT NULL;

/*
  ...
  - Added the required column `productId` to the `Deliveries` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Deliveries" ADD COLUMN     "productId" INTEGER NOT NULL,

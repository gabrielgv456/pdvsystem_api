...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "fileCertId" INTEGER,
ALTER COLUMN "created_at" SET DEFAULT CURRENT_TIMESTAMP;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_fileCertId_fkey" FOREIGN KEY ("fileCertId") REFERENCES "Images"("id") ON DELETE SET NULL ON UPDATE CASCADE;

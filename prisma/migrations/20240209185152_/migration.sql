/*
  ...
  - A unique constraint covering the columns `[id,storeId]` on the table `Clients` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Clients_id_storeId_key" ON "Clients"("id", "storeId");

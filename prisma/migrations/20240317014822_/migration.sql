/*
  ...
  - A unique constraint covering the columns `[productId]` on the table `TaxCofins` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TaxCofins_productId_key" ON "TaxCofins"("productId");

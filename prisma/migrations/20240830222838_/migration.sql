...
-- AlterTable
ALTER TABLE "TaxCstCofins" ADD COLUMN     "codSefaz" TEXT;

-- AlterTable
ALTER TABLE "TaxCstPis" ADD COLUMN     "codSefaz" TEXT;

-- AlterTable
ALTER TABLE "TaxIcmsCst" ADD COLUMN     "codSefaz" TEXT;

-- AlterTable
ALTER TABLE "TaxIcmsOrigin" ADD COLUMN     "codSefaz" TEXT;

/*
  ...
  - You are about to drop the column `itensSellId` on the `Deliveries` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Deliveries" DROP CONSTRAINT "Deliveries_itensSellId_fkey";
...
-- AlterTable
ALTER TABLE "Deliveries" DROP COLUMN "itensSellId",
ADD COLUMN     "sellId" INTEGER NOT NULL,
